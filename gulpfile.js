...
exports.watch = () => {
  ...
  gulp.watch(paths.component.styles.src, watchOptions, gulp.series(componentStylesWatch));
  gulp.watch(paths.component.scripts.src, watchOptions, gulp.series(componentScriptsWatch));
};
